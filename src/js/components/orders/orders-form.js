                    ...
                    <form id="form-excel">
                        <div class="row ms-2 me-2 pb-3">
                            <div class="col-md-3 label-over-border">
                                <label for="client-excel" class="form-label m-2">Cliente</label>
                                <select id="client-excel" class="form-select" aria-label="Default select example">
                                    <option value="0">Seleccione...</option>

                                </select>
                                <p class="error invalid-feedback" id="client-excel-error" style="color: red;"></p>
                            </div>
                    ...
                    <form id="form-manual">
                        <div class="row ms-2 me-2 pt-3 pb-3">
                            <div class="col-md-4 label-over-border">
                                <label for="client" class="form-label m-2">Cliente</label>
                                <select id="client" class="form-select" aria-label="Default select example">
                                    <option value="0">Seleccione...</option>

                                </select>
                                <p class="error invalid-feedback" id="client-error" style="color: red;"></p>
                            </div>
                            <div class="col-md-4 label-over-border">
                                <label for="order" class="form-label m-2">Número de Orden</label>
                                <input type="text" id="order" class="form-control" placeholder="0011223344">
                                <p class="error invalid-feedback" id="order-error" style="color: red;"></p>
                            </div>
                            <div class="col-md-4 label-over-border">
                                <label for="contract" class="form-label m-2">Número de Contrato</label>
                                <input type="text" id="contract" class="form-control" placeholder="0000">
                                <p class="error invalid-feedback" id="contract-error" style="color: red;"></p>
                            </div>
                        </div>
                        <div class="row ms-2 me-2 pt-3 pb-3">
                            <div class="col-md-4 label-over-border">
                                <label for="date" class="form-label m-2">Fecha</label>
                                <input type="date" id="date" class="form-control">
                                <p class="error invalid-feedback" id="date-error " style="color: red;"></p>
                            </div>
                            <div class="col-md-8 label-over-border">
                                ...
                                <p class="error invalid-feedback" id="observations-error" style="color: red;"></p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-end pt-1 me-3">
